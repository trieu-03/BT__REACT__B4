import {CHON_VE, DAT_VE } from '../modules/CinemaSeats/CinemaSeatsType'
...
export const CinemaSeatsReducer = (state = stateDefault, action) => {
	switch (action.type) {
		case CHON_VE: {
			...
			if (
				...
				(text && window.confirm('Bạn muốn hủy vé ?'))
			) {
